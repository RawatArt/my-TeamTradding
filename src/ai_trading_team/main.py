...
def main() -> int:
    """Validate the M3 configuration and exit without performing trading work."""
    try:
    ...
    logger.info(
        "m3_startup_validated",
        extra={"app_mode": settings.app_mode.value, "milestone": "M3"},
    )
