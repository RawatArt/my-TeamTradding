...
def main() -> int:
    """Validate M11 configuration and exit without starting execution or trading."""
    try:
    ...
    logger.info(
        "m11_startup_validated",
        extra={"app_mode": settings.app_mode.value, "milestone": "M11"},
    )
